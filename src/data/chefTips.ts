...
export const chefTips: Record<string, ChefTip> = {
  ...
  "gin-basil-smash": { glass: "Copo Old Fashioned com gelo", serve: "Drink moderno criado em Hamburgo, 2008. Herbáceo e fresco.", tip: "Macere MUITO manjericão — 10 folhas pelo menos. A clorofila dá cor verde linda." },
  "gin-rickey": { glass: "Copo alto (Highball)", serve: "Simples, seco e refrescante. Zero açúcar adicionado.", tip: "Sem xarope — é propositalmente seco. O limão espremido dentro do copo libera sabor continuamente." },
  ...
  "pegu-club": { glass: "Taça coupe gelada", serve: "Do lendário Pegu Club em Rangum, Myanmar. Colonial e elegante.", tip: "Dois tipos de bitters são essenciais — Angostura e orange bitters criam complexidade única." },
  ...
  "hanky-panky": { glass: "Taça coupe gelada", serve: "Criado no Savoy por Ada Coleman. Histórico e herbáceo.", tip: "O Fernet-Branca é em dose MUITO pequena — 5ml. Ele adiciona complexidade amarga e mentolada." },
  "jack-rose": { glass: "Taça coupe gelada", serve: "Clássico com applejack. Rosado e elegante.", tip: "Applejack (ou calvados) é essencial — não substitua por outro destilado. Grenadine caseira é ideal." },
  "gibson": { glass: "Taça Martini gelada", serve: "Martini com cebola cocktail. A diferença é sutil mas essencial.", tip: "A CEBOLA COCKTAIL é o que define o Gibson. Use cebolas de qualidade em conserva." },
  "angel-face": { glass: "Taça coupe gelada", serve: "Partes iguais de três ingredientes. Equilibrado e elegante.", tip: "Apricot brandy de qualidade é essencial. As proporções iguais criam harmonia perfeita." },
  "between-sheets": { glass: "Taça coupe gelada", serve: "Sidecar com rum. Mais leve e tropical.", tip: "Três destilados em harmonia: conhaque traz elegância, rum leveza, Cointreau doçura cítrica." },
  "brandy-alexander": { glass: "Taça coupe gelada", serve: "Drink de sobremesa clássico. Cremoso e indulgente.", tip: "Use creme de leite fresco batido levemente. Noz-moscada ralada na hora é obrigatória." },
  ...
  "bahia-breeze": { glass: "Copo alto (Highball)", serve: "Variação tropical do Bay Breeze. Leve e refrescante.", tip: "Rum de coco equilibra a acidez do cranberry. Abacaxi fresco como decoração é perfeito." },
  "papaya-punch": { glass: "Copo alto (Highball)", serve: "Punch tropical com mamão papaia. Cremoso e exótico.", tip: "Mamão bem maduro faz toda a diferença. O mel complementa a doçura natural da fruta." },
  "caribbean-punch": { glass: "Copo hurricane", serve: "Punch caribenho clássico. Festivo e forte.", tip: "Dois tipos de rum criam complexidade. A grenadine cria camadas de cor." },
  "pisco-sour": { glass: "Taça coupe gelada", serve: "O drink nacional do Peru e Chile. Cremoso e cítrico.", tip: "Dry shake é OBRIGATÓRIO para a espuma. As gotas de Angostura na espuma são tradição — faça um desenho." },
  "chilcano": { glass: "Copo alto (Highball)", serve: "O Mule peruano. Refrescante e leve.", tip: "Pisco quebranta é o tipo ideal. Ginger ale (não ginger beer) é o tradicional peruano." },
  "boulevardier": { glass: "Copo Old Fashioned com gelo", serve: "Negroni com bourbon. Americano e sofisticado.", tip: "Bourbon traz doçura e notas de caramelo que substituem perfeitamente o gin." },
  "sazerac": { glass: "Copo Old Fashioned sem gelo", serve: "O cocktail oficial de New Orleans. Histórico e potente.", tip: "A 'lavagem' de absinto é sutil — gire no copo e descarte o excesso. Peychaud's bitters é insubstituível." },
  "mint-julep": { glass: "Copo julep de prata ou copo alto", serve: "O drink oficial do Kentucky Derby. Sulista e refrescante.", tip: "Macere hortelã SUAVEMENTE — nunca triture. Gelo picado fino é essencial. O copo deve ficar gelado por fora." },
  "bramble": { glass: "Copo Old Fashioned com gelo picado", serve: "Criado por Dick Bradsell em 1984. Frutado e sofisticado.", tip: "O crème de mûre regado por cima cria um efeito visual dramático. Nunca misture — deixe escorrer." },
  "french-75": { glass: "Taça flûte de champagne", serve: "Drink poderoso nomeado em homenagem ao canhão francês de 75mm.", tip: "Agite gin, limão e xarope primeiro, depois complete com champagne para manter borbulhas." },
  "paloma": { glass: "Copo alto com borda de sal", serve: "O drink mais popular do México, mais que a Margarita.", tip: "Use soda de grapefruit Squirt ou Jarritos. Sal na borda é essencial. Tequila blanco é a escolha." },
  "irish-coffee": { glass: "Caneca de vidro Irish Coffee com pé", serve: "Aquecedor irlandês. Café + whiskey + creme = perfeição.", tip: "O creme deve ser batido levemente — não chantilly. Flutue pelas costas da colher. Beba o café ATRAVÉS do creme." },
  "dark-n-stormy": { glass: "Copo alto (Highball)", serve: "Rum escuro + ginger beer. Simples e poderoso.", tip: "Despeje o rum por CIMA da ginger beer — cria camadas. Gosling's é a marca tradicional." },
  "ti-punch": { glass: "Copo Old Fashioned sem gelo", serve: "Drink da Martinica. Sem gelo, como manda a tradição.", tip: "Rhum agricole é OBRIGATÓRIO — feito de cana fresca, não melaço. O disco de limão é espremido e deixado." },
  "ramos-gin-fizz": { glass: "Copo alto (Collins)", serve: "O drink mais trabalhoso da coquetelaria. Merece cada segundo.", tip: "Agite por 12-15 MINUTOS para a espuma perfeita. Água de flor de laranjeira é essencial." },
  "singapore-sling": { glass: "Copo alto (Highball ou hurricane)", serve: "Criado no Raffles Hotel em Singapura. Lendário.", tip: "A receita original usa 8 ingredientes. Cherry Heering é insubstituível. Bénédictine adiciona complexidade herbácea." },
  "zombie": { glass: "Copo tiki", serve: "Drink tiki lendário. Tão forte que era limitado a 2 por pessoa.", tip: "Três tipos de rum criam profundidade. O apricot brandy une tudo. Respeite o limite — é muito forte." },
  ...
  "naked-and-famous": { glass: "Taça coupe gelada", serve: "Moderno clássico de Phil Ward. Defumado e equilibrado.", tip: "Partes iguais dos 4 ingredientes. Yellow Chartreuse é mais suave que a verde. Mezcal dá profundidade." },
