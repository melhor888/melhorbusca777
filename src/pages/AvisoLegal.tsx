...
export default function AvisoLegal() {
  return (
    <>
      <Helmet>
        <title>Aviso Legal (Disclaimer) - Drinks & Company</title>
        <meta name="description" content="Aviso Legal da Drinks & Company. Informações sobre responsabilidade, conteúdo e limitações do site." />
        ...
        <div className="px-4 pt-16 max-w-2xl mx-auto">
          ...
          <div className="space-y-6 text-secondary-foreground leading-relaxed text-sm">
            <section>
              ...
              <p>O conteúdo disponibilizado na Drinks & Company, incluindo receitas de drinks, artigos e dicas, tem caráter exclusivamente informativo e educacional. As informações não substituem orientação profissional especializada.</p>
            </section>

            <section>
              <h2 className="text-lg font-display font-semibold text-foreground mb-2">2. Consumo Responsável</h2>
              <p>A Drinks & Company promove o consumo responsável de bebidas alcoólicas. O conteúdo deste site é destinado exclusivamente a maiores de 18 anos. Beba com moderação. Se beber, não dirija. O álcool pode causar dependência. Gestantes e lactantes não devem consumir bebidas alcoólicas.</p>
            </section>

            <section>
              <h2 className="text-lg font-display font-semibold text-foreground mb-2">3. Isenção de Responsabilidade</h2>
              <p>A Drinks & Company não se responsabiliza por:</p>
            ...
            <section>
              ...
              <p>Para questões legais: <strong>contato@drinkscompany.com.br</strong></p>
            </section>
          </div>
        </div>
        <Footer />
