...
export default function PoliticaPrivacidade() {
  return (
    <>
      <Helmet>
        <title>Política de Privacidade - Drinks & Company</title>
        <meta name="description" content="Política de Privacidade da Drinks & Company. Saiba como coletamos, usamos e protegemos seus dados pessoais conforme LGPD e GDPR." />
        ...
        <div className="px-4 pt-16 max-w-2xl mx-auto">
          ...
          <div className="space-y-6 text-secondary-foreground leading-relaxed text-sm">
            ...
            <section>
              ...
              <p className="mt-2">Para exercer qualquer desses direitos, entre em contato pelo e-mail: <strong>privacidade@drinkscompany.com.br</strong></p>
            </section>
            ...
            <section>
              ...
              <ul className="list-none space-y-1 ml-2 mt-2">
                <li><strong>E-mail:</strong> privacidade@drinkscompany.com.br</li>
