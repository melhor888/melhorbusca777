...
export default function PoliticaPrivacidade() {
  return (
    <>
      <Helmet>
        <title>Política de Privacidade - Mexi Food XP</title>
        <meta name="description" content="Política de Privacidade do Mexi Food XP. Saiba como coletamos, usamos e protegemos seus dados pessoais conforme LGPD e GDPR." />
        ...
        <div className="px-4 pt-16 max-w-2xl mx-auto">
          ...
          <div className="space-y-6 text-secondary-foreground leading-relaxed text-sm">
            ...
            <section>
              ...
              <p>Você possui direitos de acesso, correção, exclusão, portabilidade e revogação do consentimento. Para exercer, entre em contato: <strong>privacidade@mexifoodxp.com.br</strong></p>
            </section>
            <section>
              <h2 className="text-lg font-display font-semibold text-foreground mb-2">4. Contato</h2>
              <p>E-mail: privacidade@mexifoodxp.com.br</p>
            </section>
          </div>
        </div>
      </div>
