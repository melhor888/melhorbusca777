...
export default function SobreNos() {
  return (
    <>
      <Helmet>
        <title>Sobre Nós - Receitas Japonesas XP | Receitas de Comida Japonesa</title>
        <meta name="description" content="Conheça o Receitas Japonesas XP: somos apaixonados pela culinária japonesa e compartilhamos receitas autênticas, técnicas profissionais e guias completos sobre a gastronomia do Japão." />
        <link rel="canonical" href="https://japanfood.lovable.app/sobre" />
        <meta property="og:title" content="Sobre Nós - Receitas Japonesas XP" />
        <meta property="og:description" content="Conheça o Receitas Japonesas XP: receitas autênticas japonesas, técnicas profissionais e guias completos." />
      ...
      <div className="min-h-screen pb-20">
        <div className="px-4 pt-16 max-w-2xl mx-auto">
          ...
          <h1 className="text-3xl font-display font-bold text-foreground mt-4 mb-6">Sobre o Receitas Japonesas XP</h1>
          ...
          <section className="space-y-4 text-secondary-foreground leading-relaxed">
            ...
            <p>O Receitas Japonesas XP nasceu da paixão pela culinária japonesa. Nosso objetivo é democratizar o conhecimento sobre a gastronomia do Japão, oferecendo receitas autênticas, técnicas profissionais e conteúdo educacional de qualidade para entusiastas e profissionais.</p>
            ...
            <p>Todo o conteúdo publicado no Receitas Japonesas XP passa por revisão editorial rigorosa. Nossas receitas são testadas múltiplas vezes antes de serem publicadas, garantindo que você obtenha resultados excelentes ao reproduzi-las em casa.</p>

            <h2 className="text-xl font-display font-semibold text-foreground mt-8">Autenticidade</h2>
            <p>O Receitas Japonesas XP valoriza a autenticidade da culinária japonesa. Respeitamos as tradições e técnicas centenárias, ao mesmo tempo que abraçamos a evolução natural da gastronomia. Nosso conteúdo é destinado a todos que apreciam a riqueza da cultura alimentar japonesa.</p>
          </section>
        </div>
      </div>
    </>
