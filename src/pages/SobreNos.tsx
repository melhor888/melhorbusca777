...
export default function SobreNos() {
  return (
    <>
      <Helmet>
        <title>Sobre Nós - Receitas MexicanasXP | Receitas de Comida Mexicana</title>
        <meta name="description" content="Conheça o Receitas MexicanasXP: somos apaixonados pela culinária mexicana e compartilhamos receitas autênticas, técnicas profissionais e guias completos sobre a gastronomia do México." />
        <link rel="canonical" href="https://receitasmexicanas.lovable.app/sobre" />
        <meta property="og:title" content="Sobre Nós - Receitas MexicanasXP" />
      ...
      <div className="min-h-screen pb-20">
        <div className="px-4 pt-16 max-w-2xl mx-auto">
          ...
          <h1 className="text-3xl font-display font-bold text-foreground mt-4 mb-6">Sobre o Receitas MexicanasXP</h1>
          ...
          <section className="space-y-4 text-secondary-foreground leading-relaxed">
            ...
            <p>O Receitas MexicanasXP nasceu da paixão pela culinária mexicana. Nosso objetivo é democratizar o conhecimento sobre a gastronomia do México, oferecendo receitas autênticas, técnicas profissionais e conteúdo educacional de qualidade para entusiastas e profissionais.</p>
            ...
            <p>O Receitas MexicanasXP valoriza a autenticidade da culinária mexicana, reconhecida pela UNESCO como Patrimônio Cultural Imaterial da Humanidade. Respeitamos as tradições e técnicas centenárias, celebrando a riqueza da cultura alimentar do México.</p>
          </section>
        </div>
      </div>
    </>
