...
const slides: Slide[] = [
  {
    id: "hero-main",
    title: "Área VIP",
    subtitle: "1.500+ Receitas Exclusivas",
    description:
      "Descubra drinks autorais, técnicas de bartender profissional e categorias que você não encontra em nenhum outro lugar.",
    image: "/images/vip-hero-banner.jpg",
    cta: "Explorar Agora",
    ctaLink: "/vip",
  },
  {
    ...
    subtitle: "Os favoritos de sempre, repaginados",
    description:
      "Old Fashioned com infusão de baunilha, Negroni defumado, Daiquiri molecular. Técnicas modernas em receitas eternas.",
  ...
  },
  {
    ...
    description:
      "Esferificação, fat-wash, clarificação a leite. Domine as técnicas dos melhores bares do mundo.",
  ...
  },
  {
    id: "tropical",
    title: "Tropical & Tiki",
    subtitle: "Sabores paradisíacos",
    description:
      "Mai Tai, Zombie, Painkiller e criações tropicais com rum, frutas exóticas e apresentação espetacular.",
    image: getVipCategoryHero("tropical-tiki") || "/images/vip-tiki-1.jpg",
    cta: "Ver Categoria",
    ctaLink: "/vip/categoria/tropical-tiki",
  },
  {
    id: "autor",
    title: "Drinks de Autor",
    subtitle: "Criações exclusivas",
    description:
      "Receitas assinadas por bartenders renomados. Ingredientes inesperados e combinações que surpreendem.",
