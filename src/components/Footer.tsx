    ...
    <footer className="mt-12 border-t border-border/50 bg-card/50">
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div>
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><Link to="/tips" className="text-muted-foreground hover:text-primary transition-colors">Escola</Link></li>
              <li><Link to="/dicas" className="text-muted-foreground hover:text-primary transition-colors">Dicas</Link></li>
        ...
        <div className="border-t border-border/50 pt-6 space-y-3 text-center">
          ...
          <p className="text-[10px] text-muted-foreground">
            © {new Date().getFullYear()} Drinks & Company. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
